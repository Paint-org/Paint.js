...
import toolColorChooser = require('./classes/Tools/ColorChooser');
import toolSizeChooser = require('./classes/Tools/SizeChooser');
...
$(document).ready(function() {
    ...
    // Registra il tool ColorChooser per la scelta della dimensione
